...
void USART1_IRQHandler(void)
{
  ...
  if ( receive[0] == ' ') {
      if(receivedData[0] == '3' && receivedData[2] == '4'){
    	  strcpy(mang3,receivedData);
      }
      else if(receivedData[0] == '2' && receivedData[2] == '4'){
    	  strcpy(mang2,receivedData);
      }
      else if(receivedData[0] == '4' && receivedData[2] == '3' && receivedData[4] == 'A'){
    	  if (strlen(mang3) == 0) {
    		  	  HAL_UART_Transmit(&huart1,receivedData, strlen(receivedData), 100);
    	      } else {
    	          HAL_UART_Transmit(&huart1, mang3, strlen(mang3), 100);
    	          memset(mang3, 0, 15);
    	      }
      }
...
//    	  if (strlen(mangOF2) == 0) {
//    	          strcpy(mangOF2, receivedData);
//    	          HAL_UART_Transmit(&huart1, receivedData, strlen(receivedData), 100);
//    	      } else if (strcmp(receivedData, mangOF2) != 0) {
//    	    	  strcpy(mangOF2, receivedData);
//    	    	  HAL_UART_Transmit(&huart1, receivedData, strlen(receivedData), 100);
//    	      }
//      }
...
//    	  if (strlen(mangOF3) == 0) {
//    	          strcpy(mangOF3, receivedData);
//    	          HAL_UART_Transmit(&huart1, receivedData, strlen(receivedData), 100);
//    	      } else if (strcmp(receivedData, mangOF3) != 0) {
//    	    	  strcpy(mangOF3, receivedData);
//    	    	  HAL_UART_Transmit(&huart1, receivedData, strlen(receivedData), 100);
//    	      }
//      }
